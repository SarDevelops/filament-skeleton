...
use App\Filament\Resources\Template\HeaderTemplateResource\Pages;
use App\Filament\Resources\Template\HeaderTemplateResource\RelationManagers;
...
class HeaderTemplateResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Header Template';

    protected static ?string $navigationIcon = 'heroicon-o-square-3-stack-3d';

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('slug','email-header');
    }
    ...
    {
        return [
            'index' => Pages\ListHeaderTemplates::route('/'),
            'create' => Pages\CreateHeaderTemplate::route('/create'),
            'view' => Pages\ViewHeaderTemplate::route('/{record}'),
            'edit' => Pages\EditHeaderTemplate::route('/{record}/edit'),
        ];
    }
